                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Slider(
                          activeColor: Color(0xffff7f2b),
                          inactiveColor: Color(0xffff7f2b),
                          thumbColor: Color(0xffff7f2b),
                          value: volume,
                          min: 0,
                          max: 1,
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ElevatedButton(
                            style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Color(0xffff7f2b))),
